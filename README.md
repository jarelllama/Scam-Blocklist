...
In the last 30 days, more than 4,426[^1] malicious NRDs were found.
...
Today | Yesterday | Excluded | Source
   ...
   56 |       134 |       7% | Google Search
  814 |      1771 |      10% | Jeroengui phishing feed
   11 |        22 |       4% | Jeroengui scam feed
    3 |         0 |       1% | Manual Entries
  605 |       962 |      19% | PhishStats
   59 |       185 |       0% | PhishStats (NRDs)
  418 |       705 |       3% | Regex Matching (NRDs)
   11 |        12 |       8% | aa419.org
   37 |        70 |       0% | dnstwist (NRDs)
    0 |         0 |      38% | fakewebsitebuster.com
  146 |         1 |      21% | guntab.com
    6 |        20 |      10% | petscams.com
   49 |        50 |      63% | scam.directory
    9 |         4 |      38% | scamadviser.com
    0 |         0 |       6% | stopgunscams.com
 2165 |      3751 |      18% | All sources
...
``` text
Dead domains removed today: 1069
Resurrected domains added today: 301
```
...
``` text
Parked domains removed today: 287
Unparked domains added today: 118
```
