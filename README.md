...
``` text
Total domains: 120335
Light version: 9992

New domains from each source: *
Today | Yesterday | Excluded | Source
   77 |        19 |      60% | Emerging Threats phishing
   29 |        38 |       7% | Google Search
  773 |       830 |       9% | Jeroengui phishing feed
   17 |        16 |       6% | Jeroengui scam feed
    0 |         0 |       1% | Manual Entries
    0 |      1202 |      18% | PhishStats
    0 |       315 |       0% | PhishStats (NRDs)
  881 |       641 |       3% | Regex Matching (NRDs)
   12 |        31 |       7% | aa419.org
   59 |        34 |       0% | dnstwist (NRDs)
    3 |         5 |      46% | fakewebsitebuster.com
  171 |        80 |      25% | guntab.com
    1 |         2 |      60% | scam.directory
   10 |         0 |      39% | scamadviser.com
    0 |         1 |       6% | stopgunscams.com
 2033 |      2899 |      17% | All sources
...
API calls made today: 60
Domains retrieved today: 29
```
...
``` text
Dead domains removed today: 1458
Resurrected domains added today: 935
```
...
``` text
Parked domains removed today: 389
Unparked domains added today: 204
```
