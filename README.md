...
``` text
Total domains: 101038
Light version: 9305

New domains from each source: *
Today | Yesterday | Excluded | Source
    - |         1 |      62% | Emerging Threats phishing
    - |        71 |       7% | Google Search
    - |      2681 |       9% | Jeroengui phishing feed
    - |        15 |       7% | Jeroengui scam feed
    - |         0 |       1% | Manual Entries
    - |      1690 |      19% | PhishStats
    - |        65 |       0% | PhishStats (NRDs)
    - |       653 |       4% | Regex Matching (NRDs)
    - |        55 |       8% | aa419.org
    - |        76 |       0% | dnstwist (NRDs)
    - |         2 |      44% | fakewebsitebuster.com
    - |        25 |      22% | guntab.com
    - |        27 |       9% | petscams.com
    - |        13 |      65% | scam.directory
    - |         6 |      39% | scamadviser.com
