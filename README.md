...
In the last 30 days, more than 4,646[^1] malicious NRDs were found.
...
Today | Yesterday | Excluded | Source
    1 |         1 |      62% | Emerging Threats phishing
   80 |        45 |       7% | Google Search
 1164 |      1298 |      10% | Jeroengui phishing feed
   11 |        12 |       6% | Jeroengui scam feed
    0 |         0 |       1% | Manual Entries
    1 |       515 |      20% | PhishStats
    0 |        42 |       0% | PhishStats (NRDs)
  418 |       396 |       4% | Regex Matching (NRDs)
   28 |        25 |       8% | aa419.org
   16 |        24 |       0% | dnstwist (NRDs)
    0 |         1 |      42% | fakewebsitebuster.com
    8 |         9 |      21% | guntab.com
    3 |         6 |       9% | petscams.com
    0 |         0 |      65% | scam.directory
    2 |         1 |      39% | scamadviser.com
    0 |         0 |       5% | stopgunscams.com
 1732 |      2333 |      17% | All sources
...
``` text
Dead domains removed today: 741
Resurrected domains added today: 415
```
...
``` text
Parked domains removed today: 281
