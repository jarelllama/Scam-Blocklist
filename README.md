...
In the last 30 days, more than 5,329[^1] malicious NRDs were found.
...
Today | Yesterday | Excluded | Source
   98 |         0 |      62% | Emerging Threats phishing
   27 |        38 |       7% | Google Search
  959 |      1526 |      10% | Jeroengui phishing feed
    3 |        18 |       7% | Jeroengui scam feed
    7 |         0 |       1% | Manual Entries
  595 |       802 |      20% | PhishStats
   86 |        96 |       0% | PhishStats (NRDs)
  479 |       508 |       4% | Regex Matching (NRDs)
   18 |        47 |       8% | aa419.org
   47 |        38 |       0% | dnstwist (NRDs)
    0 |         0 |      43% | fakewebsitebuster.com
   16 |        94 |      22% | guntab.com
    5 |         4 |       9% | petscams.com
    0 |         3 |      65% | scam.directory
    0 |         8 |      39% | scamadviser.com
    0 |         1 |       5% | stopgunscams.com
 2254 |      3087 |      17% | All sources
...
``` text
Dead domains removed today: 1237
Resurrected domains added today: 293
```
...
``` text
Parked domains removed today: 273
Unparked domains added today: 72
```
