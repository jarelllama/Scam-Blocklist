...
In the last 30 days, more than 3,409[^1] malicious NRDs were found.
...
Today | Yesterday | Excluded | Source
    0 |         - |      59% | Emerging Threats phishing
    0 |         - |       7% | Google Search
    1 |         - |      10% | Jeroengui phishing feed
    0 |         - |       3% | Jeroengui scam feed
    0 |         - |       1% | Manual Entries
    7 |         - |      19% | PhishStats
    0 |         - |       0% | PhishStats (NRDs)
