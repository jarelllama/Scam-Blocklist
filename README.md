...
In the last 30 days, more than 5,195[^1] malicious NRDs were found.
...
Today | Yesterday | Excluded | Source
    0 |        98 |      62% | Emerging Threats phishing
    0 |        27 |       7% | Google Search
    0 |       959 |      10% | Jeroengui phishing feed
    0 |         3 |       7% | Jeroengui scam feed
    1 |         7 |       1% | Manual Entries
    0 |       595 |      20% | PhishStats
    0 |        86 |       0% | PhishStats (NRDs)
    0 |       479 |       4% | Regex Matching (NRDs)
    0 |        18 |       8% | aa419.org
    0 |        47 |       0% | dnstwist (NRDs)
...
``` text
Dead domains removed today: 440
Resurrected domains added today: 263
```
...
``` text
Parked domains removed today: 146
