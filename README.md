...
``` text
Total domains: 117479
Light version: 9844

New domains from each source: *
Today | Yesterday | Excluded | Source
    0 |         6 |      60% | Emerging Threats phishing
   29 |        52 |       7% | Google Search
  529 |       596 |       9% | Jeroengui phishing feed
   10 |         6 |       6% | Jeroengui scam feed
    0 |         0 |       1% | Manual Entries
  380 |       399 |      18% | PhishStats
   33 |        27 |       0% | PhishStats (NRDs)
  260 |       585 |       3% | Regex Matching (NRDs)
    7 |        31 |       7% | aa419.org
   21 |        34 |       0% | dnstwist (NRDs)
    0 |         0 |      45% | fakewebsitebuster.com
    0 |         5 |      24% | guntab.com
    0 |         7 |      63% | scam.directory
    0 |         3 |      39% | scamadviser.com
    0 |         0 |       6% | stopgunscams.com
 1236 |      1724 |      16% | All sources
...
``` text
Dead domains removed today: 1757
Resurrected domains added today: 622
```
...
``` text
Parked domains removed today: 352
