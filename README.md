...
In the last 30 days, more than 4,822[^1] malicious NRDs were found.
...
Today | Yesterday | Excluded | Source
    ...
    0 |       195 |       7% | Google Search
    0 |      1999 |      10% | Jeroengui phishing feed
    0 |        13 |       7% | Jeroengui scam feed
    0 |         0 |       1% | Manual Entries
    0 |      1784 |      19% | PhishStats
    0 |       204 |       0% | PhishStats (NRDs)
    0 |       656 |       4% | Regex Matching (NRDs)
    0 |        43 |       8% | aa419.org
    0 |        39 |       0% | dnstwist (NRDs)
    0 |         9 |      43% | fakewebsitebuster.com
    0 |        62 |      22% | guntab.com
    0 |        23 |       9% | petscams.com
    0 |         4 |      65% | scam.directory
    0 |         0 |      39% | scamadviser.com
    0 |         1 |       5% | stopgunscams.com
    0 |      4828 |      17% | All sources
...
``` text
Dead domains removed today: 721
Resurrected domains added today: 251
```
