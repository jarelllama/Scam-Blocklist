...
function check_raw_file {
    ...
    whitelisted_count=$(wc -l <<< "$whitelisted_domains")  # Count number of whitelisted domains
    ...
    whitelisted_tld_count=$(wc -l <<< "$whitelisted_tld_domains")  # Count number of domains with whitelisted TLDs
    ...
    in_toplist_count=$(wc -l <<< "$domains_in_toplist")  # Count number of domains found in toplist
    ...
    after_count=$(wc -l <<< "$domains")  # Count number of domains after filtering
