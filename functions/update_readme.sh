...
<li>Note that dead and parked domains that become alive/unparked are not added back into the light list (due to limitations in the way these domains are recorded)</li>
</ul>
